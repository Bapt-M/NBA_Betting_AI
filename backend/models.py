...
class MatchResult(Base):
    ...
    # Données prédictives associées (pour l'analyse a posteriori)
...
class DailyPrediction(Base):
    ...
    bet_type = Column(String) # OVER / UNDER
    
    confidence_score = Column(Float)
    recommendation = Column(String) # "High Confidence", "Value Bet"...
    
    is_processed = Column(Boolean, default=False) # Si le match a été joué et analysé
